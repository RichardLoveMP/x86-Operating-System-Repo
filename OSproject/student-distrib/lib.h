...
extern void clear_pos(int x,int y);
extern void roll();
extern void write_pos(int x,int y, uint8_t ch);
extern void write_pos_with_color(int x,int y, uint8_t ch, uint8_t color);
...
void bluescreen();//turn the screen to blue
/* Port read functions */
